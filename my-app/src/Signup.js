...
class Signup extends React.Component {
    ...
    render () {
        return (
          <form id='signup' onSubmit={this.handleSubmit.bind(this)} autocomplete="off">
            <div>
              <h2>Please register:</h2>
            </div>
            <div>
              <input id='username' type='text' placeholder='Create a username...' value={this.state.username} onChange={(evt) => {this.handleChange(evt, 'username')}
              } />
            </div>
            <div>
            <input id='email' type='text' placeholder='Enter your e-mail...' value={this.state.email} onChange={(evt) => {this.handleChange(evt, 'email')}
            } />
            </div>
            <div>
              <input id='password' type='password' placeholder='Create a password...' value={this.state.password} onChange={(evt) => {this.handleChange(evt, 'password')}} />
            </div> 
            <div>
              <input id='password2' type='password' placeholder='Confirm password...' value={this.state.password2} onChange={(evt) => {this.handleChange(evt, 'password2')}} />
            </div>
            <div>
              <button id="btn-subm" type='submit'>Submit</button>
            </div>
          </form>
        )
      }
